	...
	function setup_items()
	{
		...
		foreach($data as $val)
		{
			...
			array_push($cells, array(
				'ID' => $val['ALB_ID'],
				'utv-albthumbnail' => '<a href="?page=utubevideo&view=album&id=' . $val['ALB_ID'] . '&pid=' . $this->_id . '" title="' . __('View', 'utvg') . '"><img src="' . $this->_baseURL . $val['ALB_THUMB'] . '.jpg" class="utv-preview-thumb"/></a><span class="utv-sortable-handle" title="' . __('Click and drag to reorder') . '">::</span>',
